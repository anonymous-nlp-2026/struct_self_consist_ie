#!/usr/bin/env python3
"""Qwen CoNLL seed=456: full signal analysis.
Computes: CF1 gold-filtered degeneracy, selection F1, LP range.
"""
import json
import sys
import time
...
DATA_PATH = "/root/autodl-tmp/struct_self_consist_ie/output/exp_002_conll_n8_seed456/samples.jsonl"
SUBTASK = "ner"
...
def main():
    ...
    print(f"\n=== Qwen CoNLL seed=456 N={N_per} Full Signal Analysis ===")
    ...
    out_path = "/root/autodl-tmp/struct_self_consist_ie/output/exp_002_conll_n8_seed456/full_signal_analysis.json"
