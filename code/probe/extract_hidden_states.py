#!/usr/bin/env python3
"""Extract hidden states from Qwen3-8B SciERC model for probe experiments.

For each (instance, sample) pair in exp_012_logprob:
1. Reconstruct prompt + output JSON
2. Forward pass through model
3. Extract last-layer hidden states, mean-pool over output tokens
4. Compute per-sample NER F1 as labels

Output: hidden_states.pt, labels.pt, metadata.json
"""
