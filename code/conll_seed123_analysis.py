#!/usr/bin/env python3
"""Qwen CoNLL seed=123: full signal analysis.
...
DATA_PATH = "/root/autodl-tmp/struct_self_consist_ie/output/exp_002_conll_n8_seed123/samples.jsonl"
SUBTASK = "ner"
...
def main():
    ...
    print(f"\n=== Qwen CoNLL seed=123 N={N_per} Full Signal Analysis ===")
    ...
    out_path = "/root/autodl-tmp/struct_self_consist_ie/output/exp_002_conll_n8_seed123/full_signal_analysis.json"
