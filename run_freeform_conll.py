#!/usr/bin/env python3
"""Free-form (unconstrained) decoding for CoNLL-2003 NER.
...
def parse_args():
    ...
    p.add_argument("--model_path", type=str,
                    default="checkpoints/qwen3-8b-conll2003-merged")
    p.add_argument("--data_dir", type=str, default="data/conll2003")
    p.add_argument("--output_dir", type=str,
                    default="output/review_round9_experiments/freeform_conll")
    return p.parse_args()
...
def main():
    ...
    splits = load_conll2003(args.data_dir)
    test = splits["test"]
    print(f"CoNLL test: {len(test)} instances")
